    ...
    <>
      <div className="max-w-lg flex flex-col justify-between">
        ...
        <input
          ...
          className="w-full h-12 flex flex-row justify-between items-center dark:text-white appearance-none  max-w-lg  text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
        ></input>
      </div>
    </>
  );
